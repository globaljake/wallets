...
const setup = () => {
  ...
  if (typeof window.customElements === "undefined") {
    polyfillPromise = import(
      /* webpackChunkName: "custom-elements-polyfill" */ "@webcomponents/custom-elements"
    ).then(() => builtin(window.HTMLElement));
  } else {
    polyfillPromise = import(
      /* webpackChunkName: "custom-elements-native-shim" */ "@webcomponents/custom-elements/src/native-shim"
    ).then(() => {
